...
const config: SiteConfig = {
  ...
  site: 'https://movingonup.top',
  // The name of your site, used in the title and for SEO.
  title: 'Mia\'s Blog',
  // The description of your site, used for SEO and RSS feed.
  description:
    'Personal blog, sharing my daily life as a programming enthusiast.',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Mia Lee',
  // Keywords for SEO, used in the meta tags.
  tags: ['Programming', 'Blog', 'Technical Log', 'Life', 'Explore'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/Greendayy',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/Greendayy',
